...
reactK = (
    0.0  # ad-hoc value, SSI 2024 paper suggests 1.e^4-1.e^5 but based on 1nm scale!
)
...
while t < tmax:
    ...
    if step % 100 == 0:
        print(
            f"Plot at t={t} tstar={t*(Lrefstar**2)/(Drefstar)} (sec) c_int={c2[0],c2[50],Lrefstar*1e4*x2_nodes[50]} c_end={c2[n2-1]} itn={iteration}"
        )
        np.savetxt(
