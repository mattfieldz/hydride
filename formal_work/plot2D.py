...
x2_nodes = np.loadtxt(f'formal_work/data2D/k1e6/zero_flux/x2_nodes.dat')
x3_nodes = np.loadtxt(f'formal_work/data2D/k1e6/zero_flux/x3_nodes.dat')
...
for t in t_values:
    c2 = np.loadtxt(f'formal_work/data2D/k1e6/zero_flux/c2{t:.2f}.dat')
    alpha = np.loadtxt(f'formal_work/data2D/k1e6/zero_flux/alpha{t:.2f}.dat')
