...
t_values = [50*i+0.00001 for i in range(1,int(440))]
...
x2_nodes = np.loadtxt(f'formal_work/data2D/k0/1nm/x2_nodes.dat')
...
for t in t_values:
    t_c += 1
    c2 = np.loadtxt(f'formal_work/data2D/k0/1nm/c2{t:.2f}.dat')
    alpha = np.loadtxt(f'formal_work/data2D/k0/1nm/alpha{t:.2f}.dat')
