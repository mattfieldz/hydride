...
t_values = [dt*i+0.00000000001 for i in range(1,int(0.0052200/dt))]
...
# plt.plot(hydride_interface_arr,np.array(integral_quantity))
...
# p2, = twin1.plot(1e7 * Lrefstar * x2_nodes[0:100], c2[0:100], "C1", label=r"$c_2$")
