...
while t < tmax:
    ...
    if step % 50 == 0:
        ...
        print(
            f"Plot at t={t} tstar={t*tscaling} (sec) c_int={c2[0],alpha[0]} int={Lrefstar*hydride_interface[int(step/10)-1]} c_end={c2[n2-1]} itn={iteration}"
        )
        ...
        np.savetxt(
            f"formal_work/data1D/alpha_condon_097{t:.6f}.dat",
