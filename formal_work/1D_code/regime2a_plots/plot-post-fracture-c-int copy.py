...
plt.plot(tvalues,c0,color='red',linestyle='dashed')
plt.plot(tvalues,conc_int_pred,color='red',linestyle='solid')
# plt.plot(x2_nodes[0:300],alpha[0:300])
plt.savefig('formal_work/1D_code/regime2a_plots/figures_latex/post-fracture-interface-c.eps',format='eps',bbox_inches='tight')
