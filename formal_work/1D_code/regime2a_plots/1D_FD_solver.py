...
while t < tmax:
    ...
    if step % 100 == 0:
        ...
        np.savetxt(f"formal_work/data1D/lambdaP/tvalues_vary_diff_cs013.dat",
                t_array,
        )
        ...
        np.savetxt(
            f"formal_work/data1D/lambdaP/c2_condon_oxide_vary_diff_cs013{t:.7f}.dat",
            np.transpose(np.array([x2_nodes, c2])),
        )
        np.savetxt(
            f"formal_work/data1D/lambdaP/alpha_condon_oxide_vary_diff_cs013{t:.7f}.dat",
