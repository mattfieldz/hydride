...
tvalues = tvalues[0:int(0.018/0.005)]
...
n=150
plt.plot(x2_nodes[0:n],conc_pred[0:n],label=r'Predicted concentration',linestyle='solid',color='blue')
# # plt.plot(x2_nodes[0:400],interpolated_c_cs(x2_nodes)[0:400],label=r'Numerical concentration ($c_s=0.1$)')
plt.plot(x2_nodes[0:n],interpolated_c(x2_nodes)[0:n],label=r'Numerical concentration ($c_s=0$)',color='blue',linestyle='dashed')
...
# plt.savefig('formal_work/1D_code/regime2a_plots/post-fracture-interface-c.eps',format='eps',bbox_inches='tight')
plt.savefig('formal_work/1D_code/regime2a_plots/figures_latex/pre-fracture.eps',format='eps',bbox_inches='tight')
