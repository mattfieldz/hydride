...
np.savetxt(
            f"formal_work/data1D/asymptotic/asymptotic_small_time_UH3.dat",
            interfacealpha)
np.savetxt(
            f"formal_work/data1D/asymptotic/asymptotic_small_time_t.dat",
            tspace)
np.savetxt(
            f"formal_work/data1D/asymptotic/asymptotic_small_time_H.dat",
            interfaceconc)