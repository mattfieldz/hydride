...
Lrefstar = 1.0e1 * 1.0e-7  # using 1um=1000nm here
...
np.savetxt(
            f"formal_work/data2D/k0/1nm/x2_nodes.dat",
            x2_nodes,
        )
np.savetxt(
            f"formal_work/data2D/k0/1nm/x3_nodes.dat",
            x3_nodes,
        )
...
while t < tmax:
    ...
    if step % 100 == 0:
        ...
        np.savetxt(
            f"formal_work/data2D/k0/1nm/c3{t:.2f}.dat",
            c3,
        )
        np.savetxt(
            f"formal_work/data2D/k0/1nm/c2{t:.2f}.dat",
            c2,
        )
        np.savetxt(
            f"formal_work/data2D/k0/1nm/alpha{t:.2f}.dat",
            alpha,
        )
        # np.savetxt(
